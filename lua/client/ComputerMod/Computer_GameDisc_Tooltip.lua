...
function ISToolTipInv:render()
	...
	self.drawRectBorder = function(self, ...)
		...
		--- Custom Line 1
		self.tooltip:DrawText(font, "Titre: ", x, y + textHeight * count, mainColor[1], mainColor[2], mainColor[3], 1)
		self.tooltip:DrawText(font, game.title, x + 87, y + textHeight * count, secondColor[1], secondColor[2], secondColor[3], 1)
		count = count + 1

		--- Custom Line 2
		self.tooltip:DrawText(font, "Editeur: ", x, y + textHeight * count, mainColor[1], mainColor[2], mainColor[3], 1)
		self.tooltip:DrawText(font, game.publisher, x + 87, y + textHeight * count, secondColor[1], secondColor[2], secondColor[3], 1)
		count = count + 1

		--- Custom Line 3
		--self.tooltip:DrawText(font, "Parution:", x, y + textHeight * count, mainColor[1], mainColor[2], mainColor[3], 1)
